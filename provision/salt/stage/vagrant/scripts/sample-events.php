...
$data = array(
	array(
		...
		'eventstartdate'.$runid => date('m-d-Y', strtotime('now')),
		'eventenddate'.$runid => date('m-d-Y', strtotime('now')),
		'opponent'.$runid=>'OSU',
		'awaygame'.$runid=>1,
		'meta_title' => 'Default',
	...
	array(
		...
		'description' => 'Default',
		'short_description' => 'Default',
		'eventstartdate'.$runid => date('m-d-Y', strtotime('+15 days')),
		'eventenddate'.$runid => date('m-d-Y', strtotime('+15 days')),
		'opponent'.$runid=>'OSU',
		'awaygame'.$runid=>1,
		'meta_title' => 'Default',
		'meta_description' => 'Default',
	...
	array(
		...
		'description' => 'Default',
		'short_description' => 'Default',
		'eventstartdate'.$runid =>date('m-d-Y', strtotime('+35 days')),
		'eventenddate'.$runid =>date('m-d-Y', strtotime('+35 days')),
		'opponent'.$runid=>'IDHO',
		'awaygame'.$runid=>0,
		'meta_title' => 'Default',
		'meta_description' => 'Default',
